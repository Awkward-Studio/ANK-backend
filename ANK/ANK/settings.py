...
USE_S3_STORAGE = get_bool_env("USE_S3_STORAGE", not DEBUG)
if USE_S3_STORAGE:
    ...
    AWS_S3_ENDPOINT_URL = os.getenv("RAILWAY_BUCKET_ENDPOINT_URL")
    ...
    if missing_s3_settings:
        raise ImproperlyConfigured(
            ...
            "RAILWAY_BUCKET_NAME, RAILWAY_BUCKET_ENDPOINT_URL"
        )
