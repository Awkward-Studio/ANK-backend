...
class StorePhoneNumberView(APIView):
    ...
    def post(self, request):
        ...
        try:
            ...
            # Webhook subscriptions are app-specific and are established by
            # Embedded Signup. Do not subscribe here with the stored
            # operational token: that token may belong to ANK_ONBOARD while
            # ANK_TEST owns the webhook callback, which creates duplicate app
            # subscriptions and duplicate webhook deliveries.
